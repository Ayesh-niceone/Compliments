                ...
                <table class="table text-nowrap mb-0 align-middle" id="statuses-table">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">{{ __('Name') }}</h6>
                            </th>
                            </th>
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">{{ __('Action') }}</h6>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <form id="createStatusForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createStatusModalLabel">{{ __('Add Status') }}</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="storeStatus()"  class="btn btn-success">{{ __('Save') }}</button>
                    </div>
                </div>
            </form>
        </div>
